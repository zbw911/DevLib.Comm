...
namespace DS.Web.UCenter.Client
{
    ...
    public class UcClient : UcClientBase, IUcClient
    {
        ...
        /// <returns></returns>
        public UcUserInfo UserInfo(decimal uid)
        {
        ...
        public string UserSynlogin(decimal uid)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        /// <param name="email">Email</param>
        /// <returns></returns>
        public UcUserMerge UserMerge(string oldUserName, string newUserName, decimal uid, string passWord, string email)
        {
            var args = new Dictionary<string, string>
                           {
        ...
        /// <returns></returns>
        public int UserGetCredit(int appId, decimal uid, int credit)
        {
            int result;
            var args = new Dictionary<string, string>
                           {
        ...
        /// <param name="uid">Uid</param>
        /// <returns></returns>
        public UcPmCheckNew PmCheckNew(decimal uid)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        public int PmDelete(decimal uid, PmDeleteFolder folder, params int[] pmIds)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// <returns>删除的数量</returns>
        public int PmDelete(decimal uid, params int[] toUids)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        /// <returns></returns>
        public UcPmView PmView(decimal uid, int pmId, int toUid = 0, DateRange dateRange = DateRange.Today)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// <param name="pmId">短消息ID</param>
        /// <returns></returns>
        public UcPm PmViewNode(decimal uid, ViewType type = ViewType.Specified, int pmId = 0)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// </summary>
        /// <param name="uid">Uid</param>
        public void PmIgnore(decimal uid)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        /// <param name="uid">Uid</param>
        /// <returns></returns>
        public UcPmBlacklsGet PmBlacklsGet(decimal uid)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        /// <param name="uid">Uid</param>
        /// <returns></returns>
        public bool PmBlacklsSetAll(decimal uid)
        {
        ...
        /// <returns></returns>
        public bool PmBlacklsSet(decimal uid, params string[] userName)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// <param name="uid">Uid</param>
        /// <returns></returns>
        public bool PmBlacklsAddAll(decimal uid)
        {
        ...
        /// <param name="userName">黑名单用户名</param>
        /// <returns></returns>
        public bool PmBlacklsAdd(decimal uid, params string[] userName)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        /// <param name="uid">Uid</param>
        /// <returns></returns>
        public void PmBlacklsDeleteAll(decimal uid)
        {
        ...
        /// <param name="uid">Uid</param>
        /// <param name="userName">黑名单用户名</param>
        public void PmBlacklsDelete(decimal uid, params string[] userName)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        /// <returns></returns>
        public bool UcFriendAdd(decimal uid, int friendId, string comment = "")
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// <returns></returns>
        public bool UcFriendDelete(decimal uid, params int[] friendIds)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()}
        ...
        public int UcFriendTotalNum(decimal uid, FriendDirection direction = FriendDirection.All)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// <param name="direction">方向</param>
        /// <returns></returns>
        public UcFriends UcFriendList(decimal uid, int page = 1, int pageSize = 10, int totalNum = 10,
        ...
        /// <returns></returns>
        public bool UcCreditExchangeRequest(decimal uid, int from, int to, int toAppId, int amount)
        {
            var args = new Dictionary<string, string>
                           {
                               {"uid", uid.ToString()},
        ...
        /// <returns></returns>
        public int FeedAdd(FeedIcon icon, decimal uid, string userName, string titleTemplate, string titleData,
                           string bodyTemplate, string bodyData, string bodyGeneral, string targetIds,
        ...
        /// <param name="emails">目标email</param>
        /// <returns></returns>
        public UcMailQueue MailQueue(string subject, string message, string fromMail, string charset, bool htmlOn,
                                     int level, int[] uids, string[] emails)
        {
            var args = new Dictionary<string, string>
                           {
        ...
        private string getFlashPlayerCode(string movie)
        {
            ...
            sb.AppendLine(
                "<embed src=\"{0}\" quality=\"high\" bgcolor=\"#ffffff\" width=\"447\" height=\"477\" name=\"mycamera\" align=\"middle\" allowScriptAccess=\"always\" allowFullScreen=\"false\" scale=\"exactfit\"  wmode=\"transparent\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" />");
